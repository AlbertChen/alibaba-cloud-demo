package com.cyl.rocketmq.provider.demo;
...
@EnableBinding({ RocketmqProviderDemoApplication.MySource.class })
public class RocketmqProviderDemoApplication {

    public static void main(String[] args) {
        SpringApplication.run(RocketmqProviderDemoApplication.class, args);
    }
